...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.projectDo.UseModel(&po.Project{})
	...
	_project.BeginTime = field.NewString(tableName, "begin_time")
	_project.EndTime = field.NewString(tableName, "end_time")
	_project.CreatedTime = field.NewString(tableName, "created_time")
	_project.UpdatedTime = field.NewString(tableName, "updated_time")
	_project.Skills = field.NewString(tableName, "skills")
	_project.Works = field.NewString(tableName, "works")
...
func (p *project) updateTableName(table string) *project {
	...
	p.BeginTime = field.NewString(table, "begin_time")
	...
	p.Skills = field.NewString(table, "skills")
	p.Works = field.NewString(table, "works")
...
type IProjectDo interface {
	...
	Unscoped() IProjectDo
	Create(values ...*po.Project) error
	CreateInBatches(values []*po.Project, batchSize int) error
	Save(values ...*po.Project) error
	First() (*po.Project, error)
	Take() (*po.Project, error)
	Last() (*po.Project, error)
	Find() ([]*po.Project, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Project, err error)
	FindInBatches(result *[]*po.Project, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.Project) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.Project, error)
	FirstOrCreate() (*po.Project, error)
	FindByPage(offset int, limit int) (result []*po.Project, count int64, err error)
...
func (p projectDo) Create(values ...*po.Project) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectDo) CreateInBatches(values []*po.Project, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p projectDo) Save(values ...*po.Project) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectDo) First() (*po.Project, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.Project), nil
	}
}

func (p projectDo) Take() (*po.Project, error) {
...
func (p projectDo) Last() (*po.Project, error) {
...
func (p projectDo) Find() ([]*po.Project, error) {
	result, err := p.DO.Find()
	return result.([]*po.Project), err
}

func (p projectDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Project, err error) {
	buf := make([]*po.Project, 0, batchSize)
...
func (p projectDo) FindInBatches(result *[]*po.Project, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p projectDo) FirstOrInit() (*po.Project, error) {
...
func (p projectDo) FirstOrCreate() (*po.Project, error) {
...
func (p projectDo) FindByPage(offset int, limit int) (result []*po.Project, count int64, err error) {
...
func (p projectDo) Delete(models ...*po.Project) (result gen.ResultInfo, err error) {
